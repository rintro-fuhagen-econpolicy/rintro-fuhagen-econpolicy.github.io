...
## OLS-Regressionsmodell {#sec-ols-reg}
...
```{r}
#| label: fig-ggplot-regresults
#| fig-cap: "Regressionsergebnisse in ggplot"
#| fig-alt: "Mit ggplot erzeugte Visualisierung der Effekte aus dem Modell ols1 (ohne Intercept). Zusätzlich zum Effekt wird auch noch das 95%-Konfidenzintervall angezeigt."
plot.data <- tibble(

...
Alternativ drücken wir `F1` während wir `seq()` im Pop-Up Menü ausgewählt haben, oder wir gehen gehen direkt zum Help-Fenster und geben *seq* in die Suchfunktion ein. Im Help-Fenster (Panel C in @fig-rstudio-interface) erhalten wir dann eine ausführliche Erklärung der Funktion.

...
install.packages(
  c(
    ...
    "palmerpenguins", "wooldridge", # für penguins und wage Datensätze
    "fixest", # für FE-Regressionsmodelle und Standardfehlerberechnung
    "kableExtra", "flextable", "modelsummary" # für Export von Tabellen
    )
)
```

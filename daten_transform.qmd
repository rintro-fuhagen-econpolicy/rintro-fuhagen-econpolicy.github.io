...
dplyr::tibble(
  ...
  dplyr::mutate(var = fmt_kbl_code(var), exp = fmt_kbl_code(exp)) |>
  kbl(
...
dplyr::tibble(
  ...
  mutate(fun = fmt_kbl_code(fun), exp = fmt_kbl_code(exp)) |>
  kbl(
...
dplyr::tibble(
  ...
  mutate(Funktion = fmt_kbl_code(Funktion), Beispiel = fmt_kbl_code(Beispiel)) |>
  kbl(
    col.names = c("Funktion", "Bedeutung", "Beispiel"),
    escape = F
  ) |>
